...
OUTPUT_DIR = Path(
    r"D:\IIT mandi\Facial datasets\RAVDESS_UNIFORM10\attnvision_outputs"
)
...
# RAVDESS filename emotion field.
...
def parse_ravdess_filename(
    ...
    """
    Parse official RAVDESS filename:
...
def make_video_id(
    ...
    """
    Build a stable source-video ID.
...
def discover_ravdess_videos(
    ...
    """
    Find RAVDESS video-only files belonging to the five retained classes.
    """
    video_root = Path(
        video_root
    )
...
def prepare_ravdess_uniform_dataset(
    ...
    RAVDESS:
        ...
        -> 48x48x3
    """
    videos = discover_ravdess_videos(
        video_root
    )
...
BEST_MODEL_PATH = (
    OUTPUT_DIR
    / "best_ravdess_uniform10_attnvision.pt"
)
...
plt.title(
    "AttnVision/ViT Accuracy - RAVDESS Uniform Sampling"
)
...
plt.title(
    "AttnVision/ViT Loss - RAVDESS Uniform Sampling"
)
...
plt.title(
    ...
    "RAVDESS Uniform Sampling Every 10th Frame"
)
