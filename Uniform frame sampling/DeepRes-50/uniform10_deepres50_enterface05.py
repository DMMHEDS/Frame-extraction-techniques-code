...
OUTPUT_DIR = Path(
    r"D:\IIT mandi\Facial datasets\eNTERFACE05_UNIFORM10\deepres50_outputs"
)
...
def prepare_enterface05_uniform_dataset(
    ...
    Apply:
        ...
        -> facial preprocessing
    to every retained eNTERFACE'05 video.
    """
    videos = (
        discover_enterface05_videos(
            video_root
        )
    )
...
model.save(
    OUTPUT_DIR
    / "enterface05_uniform10_deepres50.keras"
)
...
plt.title(
    "DeepRes-50 Accuracy - eNTERFACE\'05 Uniform Sampling"
)
...
plt.title(
    "DeepRes-50 Loss - eNTERFACE\'05 Uniform Sampling"
)
